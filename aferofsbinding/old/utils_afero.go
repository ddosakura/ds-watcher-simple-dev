...
func serveFile(w http.ResponseWriter, r *http.Request, fs afero.Fs, name string, redirect bool) {
...
func dirList(w http.ResponseWriter, r *http.Request, f afero.File) {
